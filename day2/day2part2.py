...
def part2(games: list[Game]) -> int:
    ...
    for game in games:
        temp_minimum_cubes = minimum_cubes.copy()
        for cube_set in game.cube_sets:
            for cube in cube_set.cubes:
                if cube.number > temp_minimum_cubes[cube.color]:
                    temp_minimum_cubes[cube.color] = cube.number
        power: int = temp_minimum_cubes["red"] * temp_minimum_cubes["green"] * temp_minimum_cubes["blue"]
        power_sum += power
